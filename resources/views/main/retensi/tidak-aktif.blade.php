...
<div class="row">
    <div class="col-12">
        <div class="card bg-danger mb-3 card-outline text-white card-info" style="opacity: 0.8;">
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        Retensi tidak aktif adalah pasien yang kunjungan terakhir lebih dari 2 tahun terakhir
                    </div>
